...
void			raycaster(t_ray *ray, const t_game game, int *sprites, double *distance);
...
void	    	set_draw_x(t_draw *draw, const t_mlx win, const double trans_y, const int sprite_x);
